...
<div id="consultaAtletasContainer" class="consultaAtletasContainer">
	...
	<div class="filtrosBox" id="filtrosBox">
		<form method="GET" action="profiltrar.php" class="formFiltros">
			<table>
				<tr>

					<td><label for="checkEdad">Edad:</label></td>
					<td><input type="checkbox" name="checkEdad" value="checkEdad" id="checkEdad"></td>
					<td><input type="number" disabled="true" min="18" max="99" name="edad" class="edadInput"></td>
				</tr>
				<tr>
					<td><label for="checkNac">Nacionalidad:</label></td>
					<td><input type="checkbox" name="checkNac" value="checkNac" id="checkNac"></td>
					<td><select name="nacionalidadFiltro" disabled="true">
				...
				<tr>
					...
					<td><input type="checkbox" name="checkDis" value="checkDis" id="checkDis"></td>
					<td><select name="disciplinaFiltro" disabled="true">
						<?php 
